      ...
      <section>
        ...
        >
          <section   className="mb-[50px]">
            <div   className="container mx-auto">
              <div   className="w-full max-w-[800px] mx-auto">
                <div
                    className="text-[18px] leading-[28px] md:text-[20px] md:leading-[28px] mb-[36px] font-[600] text-center"
                >
                ...
                <div   className="flex flex-wrap justify-center items-center gap-y-5">
                  <div   className="w-1/2 md:w-1/3 text-center order-2 md:order-1">
                    <a href="#" title="Chat"
                      ><div
                          className="bg-tertiary w-[74px] h-[74px] mx-auto mb-[8px] rounded-full flex items-center justify-center"
                      >
                        <span
                            className="material-icons-outlined text-[40px] leading-[40px]"
                          >chat</span
                        >
                      </div>
                      <div
                          className="text-[16px] leading-[24px] font-semibold uppercase"
                      >
                        Chat
                      </div></a
                    >
                  ...
                  <div   className="w-full md:w-1/3 text-center order-1 md:order-2">
                    <div
                        className="text-[16px] leading-[24px] lg:text-[24px] lg:leading-[32px] font-semibold uppercase"
                    >
                      Contact Us
                    </div>
                  </div>
          ...
          <div   className="bg-secondary md:pt-[16px] md:pb-[16px] text-center">
            <div
                className="md:flex justify-center pl-[15px] pr-[15px] md:pl-[0] md:pr-[0]"
            >
              <div
                  className="w-full md:w-auto inline-block pl-[20px] pr-[20px] pt-[20px] pb-[20px] md:pt-0 md:pb-0 border-b md:border-b-0 md:border-r last:border-r-0 last:border-b-0 border-r-[#000000] border-b-[#fff]"
              >
                <div
              ...
              <div
                  className="w-full md:w-auto inline-block pl-[20px] pr-[20px] pt-[20px] pb-[20px] md:pt-0 md:pb-0 border-b md:border-b-0 md:border-r last:border-r-0 last:border-b-0 border-[#000000]"
              >
                <div
                    className="w-full md:w-auto flex flex-wrap justify-center items-center"
                >
          ...
          <div   className="bg-primary">
            <div
                className="container mx-auto pt-[16px] pb-[16px] lg:pt-[44px] lg:pb-[44px]"
            >
              <div
                  className="pb-[0px] lg:pb-[0px] w-full grid grid-cols-1 lg:grid-cols-3 gap-[32px]"
              >
                <div   className="order-2 lg:order-1 pl-[15px] pr-[15px]">
                  <h3
                      className="w-full text-center lg:text-left text-[20px] leading-normal font-semibold uppercase text-[#ffffff] mb-[10px]"
                  >
                    HELPFUL LINKS
                  </h3>
                  <ul
                ...
                <div
                    className="order-1 md:col-span-3 lg:col-auto lg:order-2 w-full text-center flex flex-wrap justify-center items-center mb-[24px] lg:mb-[0px]"
                >
                ...
                <div
                    className="order-3 lg:order-3 w-full text-center flex lg:items-center justify-center lg:justify-end pl-[0px] pr-[20px]"
                >
                  <div   className="inline-block text-center">
                    <div   className="mr-[5px]">
                      <h3
                          className="text-[20px] leading-[21px] font-semibold uppercase text-[#ffffff]"
                      >
                        STAY CONNECTED
                      </h3>
                      <ul
                    ...
                    <h3
                        className="pt-[30px] pb-[10px] text-[20px] leading-[28px] font-semibold text-[#ffffff] uppercase"
                    >
          ...
          <div   className="bg-[#f5f6f6]">
            <div   className="container mx-auto text-[14px] leading-[20px]">
              <div   className="pl-[15px] pr-[15px] pt-[25px] pb-[25px]">
                <div
                    className="flex flex-wrap lg: ml-[-24px] mr-[-24px] gap-y-[16px] items-center"
                >
                  <div
                      className="w-full lg:w-1/3 lg:pl-[24px] lg:pr-[24px] text-center lg:text-left"
                  >
                    <img
                      alt=""
                  ...
                  <div
                      className="w-full lg:w-1/3 lg:pl-[16px] lg:pr-[16px] text-center tracking-[1.4px]"
                  >
                    © 2023 Corporate Gear by ParsonsKellogg All Rights Reserved
                  </div>
                  <div
                      className="w-full lg:w-1/3 lg:pl-[24px] lg:pr-[24px] text-center lg:text-right"
                  >
                    <div
                        className="flex flex-wrap items-center justify-center lg:text-right lg:justify-end"
                    >
