    ...
    <div className='font-Outfit'>
      ...
      <div className=''>
        <div className='container mx-auto'>
          <div className='border-b border-b-gray-border mb-[10px] max-h-[45px] inline-block w-full'>
            <div className='flex flex-wrap justify-between py-[5px] h-[45px]'>
              <nav
                className='flex flex-wrap items-center text-small-text'
                aria-label='Breadcrumb'
              >
                <div className='hidden text-anchor hover:text-anchor-hover cursor-pointer lg:inline-block mr-4 !no-underline'>
                  &lt;&lt; Back
                </div>
                <ol className='flex flex-wrap items-center gap-y-2'>
                  <li
                    className='inline-flex items-center false'
                    aria-current='page'
                  >
                    <div className='flex items-center'>
                      <a
                        className='ml-[6px] text-anchor !no-underline'
                        title='Home'
                        href='/'
                      >
                        Home
                  ...
                  <li
                    className='inline-flex items-center pl-[6px]'
                    aria-current='page'
                  >
                    <div className='flex items-center'>
                      <span className='text-anchor !no-underline'>&gt;</span>
                      <a
                        className='ml-[6px] text-anchor !no-underline'
                        title='Women'
                        href='/women.html'
                  ...
                  >
                    <div className='flex items-center'>
                      ...
                      <a
                        className='ml-[6px] text-anchor !no-underline'
                        title='Puffer'
                        href='/women-jackets-puffer.html'
                      >
                        Puffer
                      </a>
                    </div>
                  ...
                  >
                    <div className='flex items-center'>
                      ...
                      <a
                        className='ml-[6px] text-anchor !no-underline'
                        title='Patagonia'
                        href='/patagonia.html?v=brand-product-list'
                      >
                        Patagonia
                      </a>
                    </div>
              ...
              <div className='border border-[#f0f0f0] text-default-text'>
                ...
                <div className='px-[15px] text-center'>
                  ...
                  <div className='flex flex-wrap justify-center items-center mt-[5px] mb-[10px]'>
                    ...
                    <div className='font-[600]'>$64.50</div>
                  </div>
            ...
            <div className='w-full sm:w-1/2 lg:w-1/4 px-[15px]'>
              <div className='border border-[#f0f0f0] text-default-text'>
                ...
                <div className='px-[15px] text-center'>
                  ...
                  <div className='flex flex-wrap justify-center items-center mt-[5px] mb-[10px]'>
                    <div className=''>Price:</div>
                    <div className='font-[600]'>$100.00</div>
                  </div>
                  <div className='mb-[10px] flex flex-wrap justify-center items-center gap-2.5'>
                    <a
                      href='javascript:void(0);'
            ...
            <div className='w-full sm:w-1/2 lg:w-1/4 px-[15px]'>
              <div className='border border-[#f0f0f0] text-default-text'>
                ...
                <div className='px-[15px] text-center'>
                  ...
                  <div className='flex flex-wrap justify-center items-center mt-[5px] mb-[10px]'>
                    <div className=''>Price:</div>
                    <div className='font-[600]'>$65.50</div>
                  </div>
                  <div className='mb-[10px] flex flex-wrap justify-center items-center gap-2.5'>
                    <a
                      href='javascript:void(0);'
