                    ...
                    <div className='flex items-center'>
                      ...
                      >
                        ...
                        <div
                          ...
                          //   className="absolute top-full right-0 w-80 text-sm shadow-[0_0px_5px_rgb(0,0,0,0.5)] border border-[#f4ede6] tracking-[1px]"
                          //   x-ref="panel"
                          // @mouseover="open = true"
                          style={{ display: "none" }}
                        >
                                  ...
                                  <div className='flex flex-wrap'>
                                    ...
                                    <div className='w-3/4 px-2.5'>
                                      <div className=''>
                                        ...
                                        >
                                          Eddie Bauer Men's Soft Shell Jacket
                                        </a>
                                      </div>
