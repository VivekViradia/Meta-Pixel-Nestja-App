...
export const Page = () => {
  console.log('Project page Data', ProductData)
                ...
                >
                  {
                    ProductData.map((product, index) => {
                      return (<li className="text-center" key={index} onClick={() => handleProductId(product.id)}>
                        <div className="">
                          <div className="flex text-center lg:w-auto">
                            <div
                              className="relative border border-gray-200 pb-[30px]"
                            >
                              <div
                              ...
                              <div className="mt-[24px] pl-[8px] pr-[8px]">
                                ...
                                <div
                                  className="mt-[14px] text-anchor hover:text-anchor-hover h-[44px] text-ellipsis overflow-hidden line-clamp-2 text-small-text tracking-[1.4px]"
                                >
                                  <a
                                ...
                                <div
                                  className="mt-[12px] text-[#000000] text-normal-text text-medium-text tracking-wider"
                                >
                                  <span className="font-semibold"
                                  >MSRP ${product.price}</span
                                  >
                                </div>
                              </div>
                            </div>
